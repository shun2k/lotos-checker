...
class AnalysesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create analysis" do
    assert_difference("Analysis.count") do
      post analyses_url, params: { analysis: { data: @analysis.data, times: @analysis.times } }
    end
  ...
  test "should update analysis" do
    patch analysis_url(@analysis), params: { analysis: { data: @analysis.data, times: @analysis.times } }
